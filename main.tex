...
& = \sum_{i=1}^{n}x_i y_i - n\frac{\sum_{1=1}^{n}x_i}{n}\bar{y} - n\bar{x}\bar{y} + \sum_{1=1}^{n}\bar{x}\bar{y} \\ %6
& = \sum_{i=1}^{n}x_i y_i - \sum_{1=1}^{n}x_i\bar{y} - n\bar{x}\bar{y} + \sum_{1=1}^{n}\bar{x}\bar{y} \\ %7
& = \sum_{i=1}^{n}x_i y_i - \sum_{1=1}^{n}x_i\bar{y} - \bar{x}n\bar{y} + \sum_{1=1}^{n}\bar{x}\bar{y} \\ %8
 \bar{y} = \frac{\sum_{1=1}^{n}y_i}{n} \\  %9  
& = \sum_{i=1}^{n}x_i y_i - \sum_{1=1}^{n}x_i\bar{y} - \bar{x}n\frac{\sum_{1=1}^{n}y_i}{n} + \sum_{1=1}^{n}\bar{x}\bar{y}  \\ %10 
& = \sum_{i=1}^{n}x_i y_i - \sum_{1=1}^{n}x_i\bar{y} - \bar{x}\sum_{1=1}^{n}y_i + \sum_{1=1}^{n}\bar{x}\bar{y} \\ %11   
& = \sum_{i=1}^{n}x_i y_i - \sum_{1=1}^{n}x_i\bar{y} - \sum_{1=1}^{n}\bar{x}y_i + \sum_{1=1}^{n}\bar{x}\bar{y} \\ %11.   
% last two steps
